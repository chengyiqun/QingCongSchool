...
public class TopicAdapter extends RecyclerView.Adapter<TopicAdapter.MViewHolder> {
    ...
    public TopicAdapter(List<Topic> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(@NonNull MViewHolder holder, int position) {
        ...
        for (int i = 0; i < imageList.size(); i++) {
            ...
            holder.imageViewList.get(i).setVisibility(View.VISIBLE);
            String img_uri=RetrofitFactory.baseUrl+"/QingXiao/"+(imageList.get(i).getImagePath()).replace('\\','/');
            Uri uri0 = Uri.parse(img_uri);
    ...
    public static class MViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        List<SimpleDraweeView> imageViewList=new LinkedList<>();
        ...
        public MViewHolder(View v) {
            ...
            ivuseravatar = (SimpleDraweeView) v.findViewById(R.id.iv_user_avatar);
